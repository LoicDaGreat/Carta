...
class PageController extends Controller
{
    ...
    {
        $resNoPublications = DB::table('publications')->select('*')
        ->get();
        
        return view('pages/example')
        ->with('NumberOfPublications', count($resNoPublications));
    ...
    public function List(){
        ...
        $resDuring = DB::table('publications')->select('*')
        ->where('PublicationPeriod', '=', 'During')
        ->whereBetween('Publication_Year',['2011','2021'])
          ->get();

         $resBefore = DB::table('publications')->select('*')
        ->where('PublicationPeriod', '=', 'Before')
        ->whereBetween('Publication_Year',['2011','2021'])
          ->get();

          $resAfter = DB::table('publications')->select('*')
        ->where('PublicationPeriod', '=', 'After')
        ->whereBetween('Publication_Year',['2011','2021'])
          ->get();
        ...
        //   dd($resDuring, $resBefore, $resAfter, count($resNoPublications));



      
            return response()->json([
                'CartaDuring' => $resDuring,
                'CartaBefore' => $resBefore,
                'CartaAfter' => $resAfter,
            ]);
        }
